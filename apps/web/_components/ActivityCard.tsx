...
export default function ActivityCard({ activities }: ActivityCardProps) {
  ...
  return (
    <div className="bg-slate-800 rounded-2xl p-6 shadow-lg border border-gray-700">
      ...
      <div className="space-y-4">
        {activities.length === 0 ? (
          ...
          activities.map((activity) => (
            <div
              key={activity.id}
              className="flex items-start gap-4 p-4 rounded-xl hover:bg-gray-700/50 transition-colors"
            >
