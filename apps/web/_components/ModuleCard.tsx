...
interface ModuleCardProps {
  ...
  error?: string | null;
  isUnlocked?: boolean; // New: whether this module is unlocked
  isCurrentModule?: boolean; // New: whether this is the active module
}
  ...
  return (
    ...
    >
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm ${
              ...
              {isCompleted ? '✓' : !isUnlocked ? '🔒' : module.id}
            </div>
      ...
      <div className="flex items-center justify-between">
        ...
        {!isCompleted && hasStaked && !hasCompleted && isUnlocked && (
          <button
        ...
        {/* Show locked message for locked modules */}
        {!isCompleted && hasStaked && !hasCompleted && !isUnlocked && (
