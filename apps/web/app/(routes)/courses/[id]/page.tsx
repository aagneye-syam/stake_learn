...
export default function CourseDetailPage() {
  ...
  const { hasStaked, hasCompleted, refetch } = useUserStake(
    address,
    numericCourseId
  );
  ...
  const handleStake = async () => {
    ...
    try {
      ...
      setStakeStatus(`❌ Staking failed: ${error instanceof Error ? error.message : "Unknown error"}`);
      setTimeout(() => setStakeStatus(""), 5000);
    }
  };
          ...
          <div className="sticky top-8 space-y-4">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-2xl">
              ...
              <div className="rounded-2xl p-5 mb-4" style={{ background: 'linear-gradient(135deg, #fce7f3 0%, #fbcfe8 100%)' }}>
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-2xl font-bold text-gray-900">{course.stakeAmount} ETH</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <p className="text-sm text-orange-500 font-medium">⟠ {course.stakeAmount} ETH</p>
              </div>
